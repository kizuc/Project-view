                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <li><a href="#">패션/용품 (20)</a></li>
                                                    <li><a href="#">기구 (20)</a></li>
                                                    <li><a href="#">잡화 (20)</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="collapseTwo" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
                                            <div class="shop__sidebar__brand">
                                                <ul>
                                                    <li><a href="#">브랜드 업체1</a></li>
                                                    <li><a href="#">브랜드 업체2</a></li>
                                                    <li><a href="#">브랜드 업체3</a></li>
                                                    <li><a href="#">브랜드 업체4</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <a href="details.jsp" height="5" width="10" target="_blank">
									<img src="../img/product/product-2.jpg" alt="위의 이미지를 누르면 연결됩니다.">
								<a>
                                    <ul class="product__hover">
                    	 	           <li><a href="#"><img src="../img/icon/heart.png" alt=""><span>찜하기</span></a></li>
                    		           <li><a href="../mypage/cart.jsp"><img src="../img/icon/cart.png" alt=""><span>장바구니 담기</span></a></li>
                                   </ul>
                                </div>
